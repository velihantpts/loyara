-- AlterTable
ALTER TABLE "Customer" ADD COLUMN "nudgedRewardFor" INTEGER;
...
CREATE TABLE "new_ShopConfig" (
    ...
    "nudgeEmails" BOOLEAN NOT NULL DEFAULT false,
...
INSERT INTO "new_ShopConfig" ("birthdayBonus", "brandingRemoved", "createdAt", "currency", "email", "emailNotifications", "id", "isPro", "klaviyoApiKey", "onboardedAt", "pointsExpiryDays", "pointsPerDollar", "programActive", "redeemTiers", "redemptionMode", "referralFriendDiscount", "referralReward", "reviewRequestedAt", "shop", "signupBonus", "updatedAt", "vipTiers") SELECT "birthdayBonus", "brandingRemoved", "createdAt", "currency", "email", "emailNotifications", "id", "isPro", "klaviyoApiKey", "onboardedAt", "pointsExpiryDays", "pointsPerDollar", "programActive", "redeemTiers", "redemptionMode", "referralFriendDiscount", "referralReward", "reviewRequestedAt", "shop", "signupBonus", "updatedAt", "vipTiers" FROM "ShopConfig";
